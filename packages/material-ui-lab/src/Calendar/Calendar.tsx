...
import { PickerSelectionState } from '../internal/pickers/_shared/hooks/usePickerState';
import { useGlobalKeyDown, keycode } from '../internal/pickers/_shared/hooks/useKeyDown';
...
export interface ExportedCalendarProps<TDate>
  ...
  /**
   * Custom renderer for day. Check [PickersDay API](https://material-ui.com/api/pickers-day) @DateIOType.
   */
  renderDay?: (
    day: TDate,
